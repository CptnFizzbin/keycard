...
/** `$ne` - the exact negation of `$eq` (eqOperator.ts) for the same subject/value pair, implemented directly in terms of it rather than duplicating its equality logic. No notion of a type mismatch, same as `$eq`. */
