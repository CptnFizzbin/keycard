...
public class PolicyBuilder {
    ...
    public <S> PolicyBuilder allow(Iterable<Action> actions, Subject<?> subject, @Nullable Conditions<S> condition) {
        actions.forEach(action -> this.allow(action, subject, condition));
        return this;
    }

    public <S> PolicyBuilder allow(Action action, Subject<S> subject, @Nullable Conditions<S> condition) {
    ...
    private <S> PolicyBuilder addRule(String effect, Action action, Subject<S> subject, @Nullable Conditions<S> conditions) {
        ...
        val conditionMap = conditions != null ? conditions.toMap() : null;
