 ...
 * position (SPEC_V1-0.md §3.2.1, §4, §5) - replaces the previous
...
public sealed interface WildcardToken {
    ...
    /**
     * Four-way dispatch for a raw, untyped declaration (SPEC_V1-0.md
