...
- **`meta`** — optional. Catalogues the actions/subjects in use (useful for
  tooling and validation) and can rename or disable the default wildcard tokens.
...
[§6.2.2 of the v1.0 spec](https://github.com/CptnFizzbin/keycard/blob/main/SPEC_V1-0-0.md#622-can--cannot--require).
