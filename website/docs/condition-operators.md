...
an error. See
[§5.4.6 of the v1.0 spec](https://github.com/CptnFizzbin/keycard/blob/main/SPEC_V1-0-0.md#546-substr)
...
[§5.5 of the v1.0 spec](https://github.com/CptnFizzbin/keycard/blob/main/SPEC_V1-0-0.md#55-custom-operators-op)
